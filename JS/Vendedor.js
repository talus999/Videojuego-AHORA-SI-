...
export class Vendedor {
    ...
    generarPoolObjetos() {
        return [
            ...
            new Arma(5, "Espada Legendaria Mata Titanes", "¿Necesita más descripción?", 1000, 15),
            new Arma(3, "Deux", "Una poderosa vara mágica capaz de convocar rayos", 1000, 15),
            new Arma(2, "Espada de plata", "Una espada de plata, ¿qué esperabas?", 150, 6),
